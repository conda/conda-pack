...
def build_parser():
    ...
    parser.add_argument(
        ...
        metavar="PATH",
        help=(
            "The path of the output file. Defaults to the "
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "The relative path in the archive to the conda "
    ...
    parser.add_argument(
        ...
        metavar="PATH",
        help=(
            "If present, prefixes will be rewritten to this "
    ...
    parser.add_argument(
        ...
        default="infer",
        help=(
            "The archival format to use. By default this is "
    ...
    parser.add_argument(
        ...
        default=4,
        help=(
            "The compression level to use, from 0 to 9. "
    ...
    parser.add_argument(
        ...
        default=1,
        help=(
            "The number of threads to use. Set to -1 to use "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Symbolic links aren't supported by the Zip "
    ...
    parser.add_argument(
        "--no-zip-64", action="store_true", help="Disable ZIP64 extensions."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--quiet", "-q", action="store_true", help="Do not report progress"
    )
    parser.add_argument(
        "--help", "-h", action="help", help="Show this help message then exit"
    )
    parser.add_argument("--version", action="store_true", help="Show version then exit")
    return parser
